# RANDOM PLAY MOVIE SEARCHER: README
This is the README file for the RandomPlay movie searcher. I will explain and detail the entire web page here. This includes the CSS and multiple JavaScript files.
...
<body>
    <header>
        <img src="randomplaylogo.png" width="500px" height="320px" class="logo" alt="Random Play Logo">
        <button class="theme-toggle" id="themeToggle">Change theme</button>
    </header>
    <section class="search-container">
        <input type="text" id="searchInput" placeholder="Search for a movie!">
    </section>
    <section id="resultsContainer" class="moviecontainer"></section>
    <script src="greetings.js"></script>
    <script src="movies.js"></script>
    <script src="rendering.js"></script>
    <script src="themes.js"></script>
    <script src="timer.js"></script>
    <footer><h3>&copy; Random Play. All rights reserved.</h3></footer>
</body>
</html>
```
Key points:
* The `head` tag having only 1 link: to the `stylesheet`.
* `Header` having the `themeToggle` button and the logo image.
* All the movies being under the `search-container` section.
* The multitude of `script` files, from the greeting alert to the timer at the bottom of the page.
* The `footer` being after everything, at the very very bottom of the page.
...
```
Key points:
* The `border` and `background-color` having `var()`s, because of the themetoggle.
```
theme-toggle{
    padding: 5px;
...
```
Key points:
* The `background-size/repeat/position/image` all working together to make the beautiful `themeToggle` button.
...
```
Lumping these two together for convenience.

But! Key points:
* `var()` being used again for theme toggling.
...
```
Key points:
* The movie container being how all the movies are displayed in the HTML.
* The header just being the whole movie card. 
* The logo.. is the logo. It has to be in the center of the page somehow.
...
```
Key points:
* The `searchBar`, or `input`, getting its main design.
* The `dark` theme. This is used as the default theme, and what you get if you press the `themeToggle` button while in light theme.
